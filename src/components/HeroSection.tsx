      ...
      <div className="max-w-4xl mx-auto text-center flex flex-col items-center gap-8 animate-fade-in">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Button variant="secondary" size="lg" className="gap-2" asChild>
            <a href="/Ather_Sayed_Resume.pdf" target="_blank" rel="noopener noreferrer" download>
              <Download className="h-4 w-4" /> Download CV
            </a>
          </Button>
        </div>
        <a href="#about" className="mt-12 animate-bounce text-muted-foreground hover:text-primary transition-colors" aria-label="Scroll to About section">
