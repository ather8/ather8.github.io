    ...
    <section className="min-h-screen flex items-center justify-center pt-16 px-6" aria-label="Introduction">
      <div className="max-w-4xl mx-auto text-center flex flex-col items-center gap-8 animate-fade-in">
        <div className="relative">
          <Avatar className="h-32 w-32 sm:h-36 sm:w-36 border-4 border-primary/30 ring-4 ring-primary/10">
        ...
        <div className="space-y-4 mt-4">
          <p className="text-primary text-sm font-semibold tracking-widest uppercase">Machine Learning Engineer</p>
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-foreground leading-tight">
            Hi, I'm <span className="text-primary">Ather Sayed</span>
          </h1>
          <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            I build intelligent systems that turn raw data into real-world impact — from fraud detection models with <strong className="text-foreground">92% AUC</strong> to CNNs achieving <strong className="text-foreground">99% accuracy</strong>. Specialized in Python, TensorFlow, and end-to-end ML pipelines.
          </p>
        </div>
        <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4 w-full sm:w-auto">
          ...
          <Button variant="secondary" size="lg" className="gap-2 min-h-[48px] w-full sm:w-auto" asChild>
