        ...
        <div className="max-w-2xl mx-auto space-y-6">
          <div className="bg-card border border-border rounded-xl p-8 flex gap-6 items-start">
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-4 text-sm text-muted-foreground pt-1">
                <span className="flex items-center gap-1.5"><Calendar className="h-3.5 w-3.5" aria-hidden="true" /> Graduated June 2024</span>
          ...
          <div className="bg-card border border-border rounded-xl p-8 flex gap-6 items-start">
            ...
            <div className="space-y-2">
              ...
              <span className="flex items-center gap-1.5 text-sm text-muted-foreground"><Calendar className="h-3.5 w-3.5" aria-hidden="true" /> Completed Dec 2025</span>
            </div>
          </div>
        </div>
      </div>
